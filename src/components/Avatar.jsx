...
export function Avatar(props) {
  const { scene } = useGLTF("/models/man_v2.glb");
  ...
  useFrame(() => {
    if (currentViseme.current) {
      ...
      console.log(index + " : " + nodes.Wolf3D_Head.morphTargetInfluences[index] + " : " + nodes.Wolf3D_Teeth.morphTargetInfluences[index]);
...
useGLTF.preload("/models/man_v2.glb");
